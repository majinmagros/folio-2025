...
export class Map
{
    ...
    setLocations()
    {
        ...
        this.locations.items = [
            { name: 'Conquistas', respawnName: 'achievements', offset: { x: 0, y: -0.01 } },
            { name: 'Altar', respawnName: 'altar', offset: { x: 0, y: -0.05 } },
            { name: 'Nos bastidores', respawnName: 'behindTheScene', offset: { x: 0.01, y: 0 } },
            { name: 'Bowling', respawnName: 'bowling', offset: { x: -0.08, y: 0.03 } },
            { name: 'Carreira', respawnName: 'career', offset: { x: 0, y: -0.06 } },
            ...
            { name: 'Projetos', respawnName: 'projects', offset: { x: 0, y: -0.02 } },
